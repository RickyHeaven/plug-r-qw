  ...
  <div class="boxLPB">
    ...
    <div class="bodyF" v-for="(item,index) in dataT" :key="'checkboxJ'+index">
      <div class="firstCol borderBoxKa">
        <Checkbox
            v-model="item.checked" :indeterminate="item.indeterminate" @on-change="checkChangeFirst(item,$event)"
            :disabled="disabled"
        >{{item[label]}}</Checkbox>
      </div>
      <div class="rightBoxAL">
        <div class="rightBoxInner" v-for="(secItem,indexSec) in item.children" :key="'secItem'+indexSec">
          <div class="secondCol borderBoxKa">
            <Checkbox
                v-model="secItem.checked" :indeterminate="secItem.indeterminate"
                @on-change="checkChangeSecond(secItem,$event)" :disabled="disabled"
          ...
          <div class="thirdCol borderBoxKa">
            <div class="thirdItem" v-for="(thirdItem,indexThird) in secItem.children" :key="'thirdItem'+indexThird">
              <Checkbox
                  v-model="thirdItem.checked" @on-change="updateDataT"
                  :disabled="disabled"
              >{{thirdItem[label]}}</Checkbox>
            </div>
          </div>
        </div>
      </div>
