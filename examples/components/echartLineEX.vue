	...
	<div class="examplePageL vh100">
		...
		<div class="content">
			<div class="o-hd" style="margin-bottom: 20px">
				<!--普通折线图-->
				<echart :config="dataOne" name="dataOne" ref="dataOne" widthT="calc(50% - 20px)" heightT="360px" />
				<!--堆叠面积图-->
				<echart :config="dataTwo" name="dataTwo" ref="dataTwo" widthT="calc(50% - 20px)" heightT="360px" />
				<!--渐变堆叠面积图-->
				<echart :config="dataThree" name="dataThree" ref="dataThree" widthT="calc(50% - 20px)" heightT="360px" />
				<!--可动态控制显示垂直折线图-->
				<div class="setItem">
					<i @click="openSet()" class="iconfont icon-set"></i>
					<echart :config="dataFour" :name="showDataName" :ref="showDataName" widthT="100%" heightT="360px" />
				</div>
				<!--动态设置勾选弹框-->
