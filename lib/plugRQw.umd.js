(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("ViewUI"), require("sweetalert"), require("iview-area"), require("vue-amap"), require("lodash"), require("wangeditor"), require("axios"));
	else if(typeof define === 'function' && define.amd)
		define(["ViewUI", "sweetalert", "iview-area", "vue-amap", "lodash", "wangeditor", "axios"], factory);
	else if(typeof exports === 'object')
		exports["plugRQw"] = factory(require("ViewUI"), require("sweetalert"), require("iview-area"), require("vue-amap"), require("lodash"), require("wangeditor"), require("axios"));
	else
...
// EXTERNAL MODULE: external {"root":"ViewUI","commonjs":"ViewUI","commonjs2":"ViewUI","amd":"ViewUI"}
var external_root_ViewUI_commonjs_ViewUI_commonjs2_ViewUI_amd_ViewUI_ = __webpack_require__("002d");
...
function messageBox({height, width = 416, title, content, onOk, onOkPromise, okText, cancelText, noWarnIcon, footerAlign, cancelBt}) {
  ...
  external_root_ViewUI_commonjs_ViewUI_commonjs2_ViewUI_amd_ViewUI_["Modal"].warning({
    width: width,
    render: (h) => {
      return h('div', {
        ...
        h('div', {
          ...
          h('div', {
            ...
            h('Button', {
              ...
              on: {
                click() {
                  external_root_ViewUI_commonjs_ViewUI_commonjs2_ViewUI_amd_ViewUI_["Modal"].remove()
                }
              }
            }, [
              h('Icon', {
...
/* harmony default export */ var fullScreenImgPreview = (function (src) {
  ...
  external_root_ViewUI_commonjs_ViewUI_commonjs2_ViewUI_amd_ViewUI_["Modal"].info({
    closable:false,
