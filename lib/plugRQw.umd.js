(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("view-design"), require("sweetalert"), require("vue-json-viewer"), require("iview-area"), require("vue-amap"), require("lodash"), require("wangeditor"), require("moment"), require("axios"), require("xss"));
	else if(typeof define === 'function' && define.amd)
		define(["view-design", "sweetalert", "vue-json-viewer", "iview-area", "vue-amap", "lodash", "wangeditor", "moment", "axios", "xss"], factory);
	else if(typeof exports === 'object')
		exports["plugRQw"] = factory(require("view-design"), require("sweetalert"), require("vue-json-viewer"), require("iview-area"), require("vue-amap"), require("lodash"), require("wangeditor"), require("moment"), require("axios"), require("xss"));
	else
		root["plugRQw"] = factory(root["ViewUI"], root["swal"], root["JsonView"], root["iviewArea"], root["VueAMap"], root["_"], root["wangEditor"], root["moment"], root["axios"], root["xss"]);
