(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("view-design"), require("sweetalert"), require("vue-json-viewer"), require("iview-area"), require("vue-amap"), require("lodash"), require("wangeditor"), require("moment"), require("axios"));
	else if(typeof define === 'function' && define.amd)
		define(["view-design", "sweetalert", "vue-json-viewer", "iview-area", "vue-amap", "lodash", "wangeditor", "moment", "axios"], factory);
	else if(typeof exports === 'object')
		exports["plugRQw"] = factory(require("view-design"), require("sweetalert"), require("vue-json-viewer"), require("iview-area"), require("vue-amap"), require("lodash"), require("wangeditor"), require("moment"), require("axios"));
	else
		root["plugRQw"] = factory(root["ViewUI"], root["swal"], root["JsonView"], root["iviewArea"], root["VueAMap"], root["_"], root["wangEditor"], root["moment"], root["axios"]);
  ...
  methods: {
    ...
    getLeafChecked(val, isLeaf) {
      ...
      if (isLeaf) {
        ...
        this.$emit('subVal', temp)
        this.$emit('on-change', external_root_commonjs_lodash_commonjs2_lodash_amd_lodash_default.a.cloneDepp(temp))
      }
    }
  }
});
        ...
        switch (item.type) {
          ...
          case 'checkboxGroup':
            ...
            if (item.asyncOption) { /*远程待选项*/
              ...
              item.options = external_root_commonjs_lodash_commonjs2_lodash_amd_lodash_default.a.find(temp, {key: item.borrowKey}).options
            }
...
var formR_component = normalizeComponent(
  ...
  formRvue_type_template_id_4d09e79c_render,
  formRvue_type_template_id_4d09e79c_staticRenderFns,
  false,
  null,
  null,
  null
