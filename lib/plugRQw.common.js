...
;// CONCATENATED MODULE: ./node_modules/.pnpm/vue-loader@15.11.1_bqabpjbmnlfwajo2cvaompf4cy/node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[4]!./node_modules/.pnpm/vue-loader@15.11.1_bqabpjbmnlfwajo2cvaompf4cy/node_modules/vue-loader/lib/index.js??vue-loader-options!./src/components/sideMenuPro/sideMenuPro.vue?vue&type=template&id=f83c36a8
var sideMenuProvue_type_template_id_f83c36a8_render = function render(){var _vm=this,_c=_vm._self._c;return _c('div',{ref:"menuRefRX",class:['menuBoxRPro','cannotSelect',{light:_vm.light}]},[_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.menuDisplay),expression:"menuDisplay"}],staticClass:"menuListR"},[_c('sideMenuTwoLevel',{attrs:{"data":_vm.data,"pathName":_vm.pathName}})],1),_c('sideIcoMenu',{directives:[{name:"show",rawName:"v-show",value:(!_vm.menuDisplay),expression:"!menuDisplay"}],staticClass:"icoMenuR",attrs:{"data":_vm.data,"pathName":_vm.pathName}}),_c('Icon',{staticClass:"menuShowHideIco",class:{ showIco: !_vm.menuDisplay },attrs:{"custom":_vm.typeIco,"size":14,"title":_vm.titleC},on:{"click":_vm.showHideMenu}})],1)
}
var sideMenuProvue_type_template_id_f83c36a8_staticRenderFns = []


;// CONCATENATED MODULE: ./node_modules/.pnpm/vue-loader@15.11.1_bqabpjbmnlfwajo2cvaompf4cy/node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[4]!./node_modules/.pnpm/vue-loader@15.11.1_bqabpjbmnlfwajo2cvaompf4cy/node_modules/vue-loader/lib/index.js??vue-loader-options!./src/components/sideMenuPro/sideMenuTwoLevel.vue?vue&type=template&id=413b1abe
var sideMenuTwoLevelvue_type_template_id_413b1abe_render = function render(){var _vm=this,_c=_vm._self._c;return _c('ul',{staticClass:"groupBoxRX"},_vm._l((_vm.data),function(item,i){return _c('li',{key:item?.path + i,class:{dropItemRX:item?.children,open:_vm.fromIcoMenu,fromIcoMenu:_vm.fromIcoMenu}},[_c('div',{class:_vm.getClass(item),style:({ paddingLeft: item?.level * 20 + 'px' }),on:{"click":function($event){return _vm.handleClick($event, item)}}},[_c('Icon',{staticClass:"menuIcoL",attrs:{"custom":'iconfont '+item.icon}}),_c('span',[_vm._v(_vm._s(item?.name || '-- no name --'))]),_c('Icon',{directives:[{name:"show",rawName:"v-show",value:(item.children && item.children.length > 0),expression:"item.children && item.children.length > 0"}],class:['dropIcoRX',{open:_vm.fromIcoMenu,fromIcoMenu:_vm.fromIcoMenu}],attrs:{"type":"ios-arrow-forward"}})],1),(item?.children)?_c('sideMenuProGroup',{attrs:{"data":item?.children,"path-name":_vm.pathName}}):_vm._e()],1)}),0)
}
var sideMenuTwoLevelvue_type_template_id_413b1abe_staticRenderFns = []
...
var sideMenuTwoLevel_component = normalizeComponent(
  ...
  sideMenuTwoLevelvue_type_template_id_413b1abe_render,
  sideMenuTwoLevelvue_type_template_id_413b1abe_staticRenderFns,
  false,
  null,
  null,
  null
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/vue-loader@15.11.1_bqabpjbmnlfwajo2cvaompf4cy/node_modules/vue-loader/lib/index.js??vue-loader-options!./src/components/sideMenuPro/sideMenuPro.vue?vue&type=script&lang=js
	...
	/* harmony default export */ var sideMenuProvue_type_script_lang_js = ({
		...
		methods: {
			...
			addOpen() {
				//todo 在精简模式下，激活了3级菜单，在激活其他级菜单，切换到常规模式，3级菜单的父级icon朝向不对
...
var sideMenuPro_component = normalizeComponent(
  ...
  sideMenuProvue_type_template_id_f83c36a8_render,
  sideMenuProvue_type_template_id_f83c36a8_staticRenderFns,
  false,
  null,
  null,
  null
