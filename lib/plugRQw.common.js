...
var external_root_commonjs_lodash_commonjs2_lodash_amd_lodash_ = __webpack_require__(3);
...
/* harmony import */ var _swal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(257);
/**
 * @description 公共方法集合
 * @author ricky zhangqingcq@foxmail.com
 * @created 2020.06.16
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  Z: function() { return /* binding */ swal; }
});
...
/* harmony default export */ function swal(option, text, icon) {
  ...
  return new Promise((r, j) => {
    switch ((0,functionGroup/* myTypeof */.RU)(option)) {
      case 'Object':
        ...
        if (option.text && reg.test((0,functionGroup/* myTypeof */.RU)(option.text))) {
          option.content = option.text
          delete option.text
        }
        if (option.content && (0,functionGroup/* myTypeof */.RU)(option.content) === 'String') {
          option.text = option.content
          delete option.content
        }
        if (option.button !== false) {
          if (option.buttons && (0,functionGroup/* myTypeof */.RU)(option.buttons) === 'Object') {
          ...
          else if (option.buttons && (0,functionGroup/* myTypeof */.RU)(option.buttons) === 'Array') {
            if (option.buttons[0]) {
        ...
        external_root_swal_commonjs_sweetalert_commonjs2_sweetalert_amd_sweetalert_default()(option)
          .then(res => {
            if (res && (0,functionGroup/* myTypeof */.RU)(option.onOk) === 'Function') {
              option.onOk()
            }
            r(res)
          })
      ...
      case 'String':
        ...
        if (text) {
          switch ((0,functionGroup/* myTypeof */.RU)(text)) {
            case 'String':
...
/* harmony import */ var _locale__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(66);
...
/******/ 			return "plugRQw.common." + chunkId + ".js";
/******/ 		};
/******/ 	}();
/******/ 	
...
/******/ 	!function() {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "@zhangqingcq/plug-r-qw:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = (typeof self !== 'undefined' ? self : this)["webpackChunk_zhangqingcq_plug_r_qw"] = (typeof self !== 'undefined' ? self : this)["webpackChunk_zhangqingcq_plug_r_qw"] || [];
...
;// CONCATENATED MODULE: external {"root":"ViewUI","commonjs":"@zhangqingcq/view-design-r","commonjs2":"@zhangqingcq/view-design-r","amd":"@zhangqingcq/view-design-r"}
var view_design_r_namespaceObject = require("@zhangqingcq/view-design-r");
// EXTERNAL MODULE: ./src/locale/index.js + 4 modules
var locale = __webpack_require__(66);
...
function messageBox({
  ...
  view_design_r_namespaceObject.Modal.warning({
    width: width,
    render: (h) => {
      return h('div', {
        ...
        h('div', {
          ...
          h('div', {
            ...
            h('span', title || T('r.info.title')), h('Button', {
              ...
              on: {
                click() {
                  view_design_r_namespaceObject.Modal.remove()
...
// EXTERNAL MODULE: ./src/methods/swal.js + 1 modules
var swal = __webpack_require__(257);
...
/* harmony default export */ function fullScreenImgPreview(src) {
  ...
  view_design_r_namespaceObject.Modal.info({
    closable: false,
    'transition-names': [
      'linear', 'fade'
    ],
